...
$expiration_temps_seconde = 3600;
$path = "/";
setcookie($nom_cookie,$valeur_cookie,time() + $expiration_temps_seconde,$path)
?>

<!DOCTYPE html>
<html lang="en">
<script>
function setCookie(nom_coukie,valeur_cookie,expiration_temps_seconde)
{
var date_temp = new Date();
date_temp.setTime(date_temp.getTime() + expiration_temps_seconde);
...
{
    echo("On ne connais pas votre nom" );
}
